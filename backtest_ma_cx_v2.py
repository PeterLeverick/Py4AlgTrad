""" 
    ...
    This version gets OHLC from the master file with the historical data from Jan 1st 2020  
...
''' get ohlc from kraken ''' # not in use in this version
...
def main():
    ...
    ''' get ohlc from master file '''
    #crypto_pair = 'ETHUSDT'
    #interval = '1440'
    asset_df = get_master_ohlc_CSV()
