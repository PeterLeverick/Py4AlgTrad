"""
    ...
    -Script 2 (this one) --> To get larger database, we transform ticks into OHLC (see ticksToOhlc.py) to create the MasterFile
...
end = datetime(2021, 2, 15, 19, 00, 00000) #Eastern
print(end)
...
# candles interval --> ticks will be converted into OHLC in this interval 
...
# 2.1 OHLC
#timeframe = 'D'    # '1440min'   #timeframe = 'D'    #timeframe = '15Min'   #see variable at the beginning 
